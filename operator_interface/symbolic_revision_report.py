...
def generate_revision_report(results: List[Dict[str, Any]], output_md: str = "symbolic_revision_report.md"):
    """
    ...
    try:
        ...
        with open(output_md, "w") as f:
            ...
            f.write("|----------|--------------|----------------|\n")
            for r in results[:10]:
                f.write(f"| {r['original_trace_id']} | {r['alignment_delta']} | {r['original_license']} → {r['revised_license']} |\n")
