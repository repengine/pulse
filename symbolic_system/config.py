...
class SymbolicConfig:
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        if os.path.exists(self._config_file):
            try:
                ...
                logger.error(f"Error loading symbolic config from {self._config_file}: {e}")
        ...
        try:
            ...
            logger.info(f"Created default symbolic configuration at {self._config_file}")
        except Exception as e:
            logger.error(f"Error saving default symbolic config to {self._config_file}: {e}")
    ...
    def set_active_profile(self, profile_name: str):
        ...
        if profile_name in self._config.get("profiles", {}):
            ...
            logger.warning(f"Profile '{profile_name}' not found, staying with {self._active_profile}")
