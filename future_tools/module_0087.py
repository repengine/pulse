"""
Module 0087: [Short description of module purpose]
"""
...
class Module0087Error(PulseError):
    """Custom exception for Module 0087."""
...
def main_function(input_data: list[int]) -> int:
    ...
    Raises:
        Module0087Error: [When/why this is raised]
    """
    logger.info("Starting main_function in Module 0087")
    if not isinstance(input_data, list):
        logger.error("Input data must be a list of integers.")
        raise Module0087Error("Input data must be a list of integers.")
    # ...module logic here...
