...
class DataStoreConfig:
    ...
    index_fields: List[str] = field(
        default_factory=lambda: ["id", "timestamp", "source"]
    )
...
class FeatureProcessingConfig:
    ...
    # Processing options
    default_processors: List[str] = field(
        default_factory=lambda: ["normalize", "tokenize"]
    )
    enable_auto_scaling: bool = True

    # Feature extraction
    feature_extraction_methods: List[str] = field(
        default_factory=lambda: ["basic", "dict_rules", "object_rules"]
    )
...
class IntegrationConfig:
    ...
    # Event handling
    events_to_subscribe: List[str] = field(
...
class RecursiveTrainingConfig:
    ...
    feature_processing: FeatureProcessingConfig = field(
        default_factory=FeatureProcessingConfig
    )
