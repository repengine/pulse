"""
Module 0004: [Short description of module purpose]
"""
...
class Module0004Error(PulseError):
    """Custom exception for Module 0004."""
...
def main_function(input_data: list[int]) -> int:
    ...
    Raises:
        Module0004Error: [When/why this is raised]
    """
    logger.info("Starting main_function in Module 0004")
    if not isinstance(input_data, list):
        logger.error("Input data must be a list of integers.")
        raise Module0004Error("Input data must be a list of integers.")
    # ...module logic here...
