...
if TYPE_CHECKING:
    from simulation_engine.worldstate import WorldState, SymbolicOverlays, Variables
    from simulation_engine.turn_engine import run_turn  # If used for retrodiction
else:
    try:
        from simulation_engine.worldstate import WorldState, SymbolicOverlays, Variables
...
try:
    ...
    from core.pulse_learning_log import log_learning_event  # If used
except ImportError:
