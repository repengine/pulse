"""
Module 0002: [Short description of module purpose]
"""
...
class Module0002Error(PulseError):
    """Custom exception for Module 0002."""
...
def main_function(input_data: list[int]) -> int:
    ...
    Raises:
        Module0002Error: [When/why this is raised]
    """
    logger.info("Starting main_function in Module 0002")
    if not isinstance(input_data, list):
        logger.error("Input data must be a list of integers.")
        raise Module0002Error("Input data must be a list of integers.")
    # ...module logic here...
