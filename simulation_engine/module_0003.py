"""
Module 0003: [Short description of module purpose]
"""
...
class Module0003Error(PulseError):
    """Custom exception for Module 0003."""
...
def main_function(input_data: list[int]) -> int:
    ...
    Raises:
        Module0003Error: [When/why this is raised]
    """
    logger.info("Starting main_function in Module 0003")
    if not isinstance(input_data, list):
        logger.error("Input data must be a list of integers.")
        raise Module0003Error("Input data must be a list of integers.")
    # ...module logic here...
