"""
Module 0090: [Short description of module purpose]
"""
...
class Module0090Error(PulseError):
    """Custom exception for Module 0090."""
...
def main_function(input_data: list[int]) -> int:
    ...
    Raises:
        Module0090Error: [When/why this is raised]
    """
    logger.info("Starting main_function in Module 0090")
    if not isinstance(input_data, list):
        logger.error("Input data must be a list of integers.")
        raise Module0090Error("Input data must be a list of integers.")
    # ...module logic here...
