...
from simulation_engine.state_mutation import decay_overlay # noqa E402
from simulation_engine.rule_engine import run_rules # noqa E402
...
from simulation_engine.utils.simulation_trace_logger import ( # noqa E402
...
def reverse_rule_engine(
    ...
    """
    from simulation_engine.rules.reverse_rule_engine import (
        trace_causal_paths,
        get_fingerprints,
    )
    from trust_system.trust_engine import TrustEngine
...
if __name__ == "__main__":
    ...
    if args.selftest:
        ...
        if args.explain_gravity:
            try:
                from simulation_engine.worldstate_monitor import (
