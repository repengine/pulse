...
class TestAPIToCeleryIntegration:
    ...
    def test_autopilot_engage_to_task_completion(
        self, integration_client, mock_celery_app
    ):
        ...
        response = integration_client.post(
            "/autopilot/engage",
            json={"action": "start_trading", "parameters": {"risk_level": "medium"}},
        )
        ...
        mock_celery_app.send_task.assert_called_once_with(
            "autopilot_engage_task", args=["start_trading", {"risk_level": "medium"}]
        )
    ...
    def test_task_failure_handling(self, integration_client, mock_celery_app):
        ...
        # Act - Submit task
        response = integration_client.post(
            "/autopilot/engage", json={"action": "start_trading", "parameters": {}}
        )
...
class TestAutopilotWorkflow:
    ...
    def test_autopilot_engage_disengage_cycle(
        self, integration_client, mock_celery_app
    ):
...
class TestRetrodictionWorkflow:
    ...
    def test_retrodiction_with_learning_audit(
        self, integration_client, mock_celery_app
    ):
...
class TestSignalIngestionWorkflow:
    ...
    def test_signal_ingestion_to_forecast_generation(
        self, mock_scraper, integration_client
    ):
