...
from forecast_engine import forecast_regret_engine
...
def feedback_loop(regrets: List[Dict[str, Any]], log_path: Optional[str] = None) -> None:
    """
...
def sample_forecasts():
    return [
        {"trace_id": "a", "retrodiction_score": 0.4, "forecast_capital": {"nvda": 100, "msft": 200}, "symbolic_tag": "hope", "forecast_overlay": {"hope": 0.5}},
        {"trace_id": "b", "retrodiction_score": 0.8, "forecast_capital": {"nvda": 120, "msft": 180}, "symbolic_tag": "despair", "forecast_overlay": {"hope": 0.2}},
        {"trace_id": "c", "retrodiction_score": 0.3, "missed_asset": "spy", "symbolic_tag": "hope", "forecast_overlay": {"hope": 0.7}},
    ]
...
def test_analyze_regret_over_under(sample_forecasts, sample_actuals):
    ...
    assert any(r["reason"] in ("Under-forecasted asset", "Over-forecasted asset") for r in regrets)
