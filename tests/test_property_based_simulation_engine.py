...
def test_overlay_bounds(hope, despair, rage, fatigue, trust):
    from simulation_engine.worldstate import SymbolicOverlays  # Updated to correct class name
    overlay = SymbolicOverlays(hope=hope, despair=despair, rage=rage, fatigue=fatigue, trust=trust)
