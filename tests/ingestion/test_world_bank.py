...
from ingestion.iris_plugins_variable_ingestion.worldbank_plugin import WorldBankPlugin
...
# Add the parent directory to the path to allow importing the ingestion.package
