...
from symbolic_system.numeric_transforms import get_numeric_transformer, SymbolicNumericTransformer
...
class TestSymbolicNumericIntegration(unittest.TestCase):
    ...
    def test_numeric_to_symbolic(self):
        ...
        overlay_name, value, confidence = self.transformer.numeric_to_symbolic("volatility_index", 30)
        ...
        overlay_name, value, confidence = self.transformer.numeric_to_symbolic("price_momentum", 5)
    ...
    def test_apply_numeric_to_state(self):
        ...
        # Apply to state
        transformations = self.transformer.apply_numeric_to_state(self.state, indicators)
        ...
        self.assertTrue(hasattr(self.state.overlays, "fear") or "fear" in self.state.overlays._dynamic_overlays)
    ...
    def test_adaptive_thresholds(self):
        ...
        self.assertAlmostEqual(self.transformer.adaptive_thresholds["volatility_index_high"], 
    ...
    def test_dynamic_overlay_creation(self):
        ...
        confidence_value = getattr(self.state.overlays, "confidence", 
    ...
    def test_confidence_scoring(self):
        ...
        self.transformer._record_transformation("volatility_index", 30, "fear", 0.7, 0.8)
        self.transformer._record_transformation("volatility_index", 25, "fear", 0.6, 0.7)
