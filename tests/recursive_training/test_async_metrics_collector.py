...
from recursive_training.metrics.async_metrics_collector import AsyncMetricsCollector, get_async_metrics_collector
...
class TestAsyncMetricsCollector(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('recursive_training.metrics.async_metrics_collector.get_metrics_store', 
    ...
    def test_error_callback(self):
        ...
        self.mock_metrics_store.store_metric.side_effect = Exception("Permanent failure")
