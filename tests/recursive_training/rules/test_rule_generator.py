...
def sample_context():
    ...
    return {
        ...
        "example_scenarios": [
            {"price": 120, "category": "electronics", "quantity": 1, "customer_type": "regular", "expected_discount": 0.0},
            {"price": 200, "category": "electronics", "quantity": 2, "customer_type": "premium", "expected_discount": 0.1},
            {"price": 50, "category": "books", "quantity": 5, "customer_type": "regular", "expected_discount": 0.05}
        ]
    }
...
def rule_generator(mock_config, mock_cost_controller, mock_metrics_store):
    ...
    with patch('recursive_training.rules.rule_generator.get_cost_controller') as mock_get_cost_controller:
        with patch('recursive_training.rules.rule_generator.get_metrics_store') as mock_get_metrics_store:
            with patch('recursive_training.rules.rule_generator.get_config') as mock_get_config:
                # Setup mocks
                ...
                generator._generate_with_gpt = MagicMock(return_value={
                    "id": "test_rule_1",
                    "type": "discount",
                    "conditions": [
                ...
                generator._generate_with_symbolic = MagicMock(return_value={
                    "id": "test_rule_2",
                    "type": "discount",
                    "conditions": [
                ...
                generator._evaluate_rule_quality = MagicMock(return_value=(
                    0.8,  # quality score
                    {
                        "overall_quality": 0.8,
                        "issues": [],
                ...
                generator._refine_rule = MagicMock(side_effect=lambda rule, feedback: {
                    **rule,
...
class TestRuleGeneration:
    ...
    def test_cost_control_limits(self, rule_generator, sample_context, mock_cost_controller):
