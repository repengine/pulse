...
def test_check_trigger_window_not_full(basic_monitor):
    ...
    basic_monitor.record_step({"var1": 1.0}, {"var1": 1.0}, 1) # Window size 3, only 1 step recorded
...
def test_check_trigger_above_threshold_single_variable(basic_monitor):
    ...
    basic_monitor.record_step({"var1": 1.0, "var2": 1.0}, {"var1": 1.0, "var2": 0.1}, 2) # Window full
...
def test_check_trigger_above_threshold_multiple_variables():
    ...
    monitor.record_step({"vA": 1, "vB": 2, "vC": 1}, {"vA": 2, "vB": 1, "vC": 3}, 1) # Window full
...
def test_check_trigger_rolling_window_effect():
    ...
    monitor = ShadowModelMonitor(threshold=0.5, window_steps=2, critical_variables=["var1"])
