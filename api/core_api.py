...
def run_retrodiction_simulation():
    ...
    try:
        ...
        Thread(
            target=_run_retrodiction_background,
            args=(run_id, start_date, days, variables_of_interest),
        ).start()
    ...
    try:
        ...
        for var in variables_of_interest:
            results[var] = {
                ...
                "dates": [
                    (
                        datetime.fromisoformat(start_date) + datetime.timedelta(days=i)
                    ).strftime("%Y-%m-%d")
                    for i in range(days)
                ],
            }
...
def get_autopilot_status():
    ...
    return jsonify(
        {
            "message": "Autopilot status endpoint - Not implemented yet",
            "status": "unknown",
        }
    )
...
def get_autopilot_data():
    ...
    return jsonify(
        {"message": "Autopilot data endpoint - Not implemented yet", "data": {}}
    )
