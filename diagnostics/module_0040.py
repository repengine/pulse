"""
Module 0040: [Short description of module purpose]
"""
...
class Module0040Error(PulseError):
    """Custom exception for Module 0040."""
...
def main_function(input_data: list[int]) -> int:
    ...
    Raises:
        Module0040Error: [When/why this is raised]
    """
    logger.info("Starting main_function in Module 0040")
    if not isinstance(input_data, list):
        logger.error("Input data must be a list of integers.")
        raise Module0040Error("Input data must be a list of integers.")
    # ...module logic here...
