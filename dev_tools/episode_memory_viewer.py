...
def main():
    ...
    parser.add_argument("--log", type=str, default="logs/forecast_episodes.jsonl", help="Path to episode log")
    parser.add_argument("--summary", action="store_true", help="Print arc and tag summary")
    parser.add_argument("--plot", action="store_true", help="Display arc frequency plot")
    parser.add_argument("--export", type=str, help="Optional path to export summary as JSON")
