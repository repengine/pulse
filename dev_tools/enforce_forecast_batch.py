...
def main():
    ...
    parser.add_argument(
        "--output", required=True, help="Path to save approved forecasts"
    )
    parser.add_argument(
        "--rejected", type=str, help="Optional: save unlicensed forecasts here"
    )
    parser.add_argument(
        "--summary", action="store_true", help="Print license breakdown"
    )
