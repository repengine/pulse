...
def propose_upgrades():
    ...
    upgrades = {
        "proposed_variables": [v for v, c in var_counts.most_common(10) if v != "unknown"],
        "proposed_consequences": [c for c, n in cons_counts.most_common(10) if c != "unknown"],
...
def main():
    ...
    parser.add_argument("--output", type=str, required=True, help="Path to save upgrade plan JSON")
