"""
Module 0015: [Short description of module purpose]
"""
...
class Module0015Error(PulseError):
    """Custom exception for Module 0015."""
...
def main_function(input_data: list[int]) -> int:
    ...
    if not isinstance(input_data, list):
        ...
        raise Module0015Error("Input data must be a list of integers.")
    # ...module logic here...
