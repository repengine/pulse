...
class PulseApp:
    ...
    def fetch_autopilot_history(self):
        ...
        if data and isinstance(data, list):
            ...
            error_message = data.get('error', 'Unknown error') if data and isinstance(data, dict) else 'Failed to fetch history.'
...
if __name__ == "__main__":
    root = tk.Tk()
    app = PulseApp(root)
    root.mainloop()_frame.pack(fill="both", expand=True, pady=5)
