...
def start_api_server():
    ...
    api_server_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "pulse_api_server.py")
...
def start_gui():
    """Start the Pulse GUI."""
    gui_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "pulse_tkinter_ui.py")
