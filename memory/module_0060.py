"""
Module 0060: [Short description of module purpose]
"""
...
class Module0060Error(PulseError):
    """Custom exception for Module 0060."""
...
def main_function(input_data: list[int]) -> int:
    ...
    Raises:
        Module0060Error: [When/why this is raised]
    """
    logger.info("Starting main_function in Module 0060")
    if not isinstance(input_data, list):
        logger.error("Input data must be a list of integers.")
        raise Module0060Error("Input data must be a list of integers.")
    # ...module logic here...
