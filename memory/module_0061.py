"""
Module 0061: [Short description of module purpose]
"""
...
class Module0061Error(PulseError):
    """Custom exception for Module 0061."""
...
def main_function(input_data: list[int]) -> int:
    ...
    Raises:
        Module0061Error: [When/why this is raised]
    """
    logger.info("Starting main_function in Module 0061")
    if not isinstance(input_data, list):
        logger.error("Input data must be a list of integers.")
        raise Module0061Error("Input data must be a list of integers.")
    # ...module logic here...
