...
logger = logging.getLogger("rule_fingerprint_expander")
...
def suggest_fingerprint_from_delta(delta: dict, rule_id: str = None) -> dict:
    ...
    Returns a dict with rule_id and effects.
    """
...
def validate_fingerprints_file(path: str):
    """
    Validate a fingerprints file for required schema.
    ...
    try:
        ...
        if errors:
            ...
            logger.info("✅ All fingerprints valid.")
