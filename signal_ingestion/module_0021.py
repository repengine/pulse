"""
Module 0021: [Short description of module purpose]
"""
...
class Module0021Error(PulseError):
    """Custom exception for Module 0021."""
...
def main_function(input_data: list[int]) -> int:
    ...
    Raises:
        Module0021Error: [When/why this is raised]
    """
    logger.info("Starting main_function in Module 0021")
    if not isinstance(input_data, list):
        logger.error("Input data must be a list of integers.")
        raise Module0021Error("Input data must be a list of integers.")
    # ...module logic here...
